...
import aiAdventurerImg from '../../assets/aiadventurer.png';

interface TestimonialCardProps {
  handleShuffle: () => void;
  testimonial: string;
  position: "front" | "middle" | "back" | "extra";
  id: number;
  author: string;
}
...
export function TestimonialCard({ handleShuffle, testimonial, position, id, author }: TestimonialCardProps) {
  ...
  return (
    ...
    >
      <img
        src={id === 1 ? pranayImg : id === 2 ? yashImg : id === 3 ? airAsiaImg : id === 4 ? aiAdventurerImg : `https://i.pravatar.cc/128?img=${id + 10}`}
...
const testimonials = [
  ...
  {
    id: 4,
    testimonial: "These guys helped me grow my account from 60k to 117k and helped me to generate millions of views with high quality edits and scripting.",
    author: "@aiadventureryt"
  }
];

export function ShuffleCards() {
  const [positions, setPositions] = React.useState<("front" | "middle" | "back" | "extra")[]>(["front", "middle", "back", "extra"]);
