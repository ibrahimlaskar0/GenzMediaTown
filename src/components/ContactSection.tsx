                ...
                {socialLinks.map((social) => {
                  ...
                  return (
                    <motion.a
                      ...
                      whileHover={{ y: -2 }}
                      whileTap={{ scale: 0.95 }}
                      className={`flex items-center justify-center p-4 bg-dark-surface rounded-xl border border-dark-border hover:shadow-lg transition-all duration-200 text-dark-text ${social.color} w-full max-w-xs`}
                    >
